		...
		<div class="content">
			...
			<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" name="nim" value="<?php echo $row ['code']; ?>" class="form-control" placeholder="nim" required>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="dosen_pembimbing" value="<?php echo $row ['dosen_pembimbing']; ?>" class="form-control" placeholder="Dosen Pembimbing" >
					</div>
				</div>
				<div class="form-group">
